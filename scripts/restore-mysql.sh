...
DB_CONTAINER="${DB_CONTAINER:-${MYSQL_CONTAINER_NAME:-vietnet2026-mysql-1}}"
DB_NAME="${DB_NAME:-${MYSQL_DATABASE:-vietnet}}"
DB_USER="${DB_USER:-${MYSQL_USER:-vietnet}}"
LOG_FILE="${LOG_FILE:-/var/log/vietnet/restore.log}"
ENV_FILE="${ENV_FILE:-/opt/vietnet/.env}"
