...
interface ProjectsClientProps {
  initialData?: PaginatedInitialData<Project>
}
...
function ProjectsContent({ initialData }: ProjectsClientProps) {
  ...
  const { items: projects, meta, page, loading, error, goToPage, refresh, isEmpty } =
    usePaginatedList<Project>({
      ...
      // Chi hydrate khi khong co filter — SSR chi fetch page 1 khong filter.
      initialData: currentCategory ? undefined : initialData,
    })
