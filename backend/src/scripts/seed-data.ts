...
async function seed() {
  ...
  // ── Categories ──────────────────────────────────────────────
  // Dong bo voi categories.service.ts seed() — chi tao cac parent categories co ban
  const projectCategories = [
    { name: 'Phòng Khách', slug: 'phong-khach', type: 'project' },
    { name: 'Phòng Ngủ', slug: 'phong-ngu', type: 'project' },
    { name: 'Phòng Bếp', slug: 'phong-bep', type: 'project' },
    { name: 'Căn Hộ Chung Cư', slug: 'can-ho-chung-cu', type: 'project' },
    { name: 'Nhà Phố', slug: 'nha-pho', type: 'project' },
    { name: 'Biệt Thự', slug: 'biet-thu', type: 'project' },
    { name: 'Văn Phòng', slug: 'van-phong', type: 'project' },
    { name: 'Showroom', slug: 'showroom', type: 'project' },
    { name: 'Khách Sạn & Resort', slug: 'khach-san-resort', type: 'project' },
    { name: 'Nhà Hàng & Café', slug: 'nha-hang-cafe', type: 'project' },
  ]

  const productCategories = [
    { name: 'Sofa & Ghế Sofa', slug: 'sofa-ghe-sofa', type: 'product' },
    { name: 'Bàn', slug: 'ban', type: 'product' },
    { name: 'Ghế', slug: 'ghe', type: 'product' },
    { name: 'Giường Ngủ', slug: 'giuong-ngu', type: 'product' },
    { name: 'Tủ & Kệ', slug: 'tu-ke', type: 'product' },
    { name: 'Đèn Trang Trí', slug: 'den-trang-tri', type: 'product' },
    { name: 'Phụ Kiện Trang Trí', slug: 'phu-kien-trang-tri', type: 'product' },
  ]
      ...
      sections: [
        {
          ...
          config: {
            ...
            subtitle: 'VietNet Interior mang hồn thủ công Việt Nam vào không gian kiến trúc hiện đại, tạo nên những chốn nghỉ ngơi ấm áp và tinh xảo.',
        ...
        },
        {
          ...
          config: {
            ...
            description: 'Được thành lập trên nguyên tắc "Thủ Công Tinh Xảo", VietNet Interior vượt qua khuôn khổ thiết kế truyền thống. Chúng tôi kiến tạo không gian sống trở thành bối cảnh lặng lẽ cho những khoảnh khắc ý nghĩa nhất của bạn.',
        ...
        {
          type: 'featured_projects', order: 3, visible: true,
          config: {
            label: 'Di Sản',
            ...
            items: [
              {
                ...
                content: 'VietNet đã biến tầm nhìn của chúng tôi thành một không gian vừa sang trọng vừa mang đậm dấu ấn cá nhân. Sự tỉ mỉ trong từng mối ghép gỗ là điều hiếm thấy trong khu vực.',
              },
              {
                name: 'Thomas H.',
                role: 'Nhà sưu tập kiến trúc',
                content: 'Chuyên nghiệp ở mọi giai đoạn. Họ xử lý sự phức tạp kiến trúc của ngôi nhà nghỉ dưỡng trên đồi một cách tinh tế và mang đến một ngôi nhà hòa mình với cảnh quan.',
              },
            ],
          },
        },
        {
          type: 'contact_cta', order: 5, visible: true,
          config: {
            title: 'Sẵn sàng định hình không gian của bạn?',
            description: 'Dù bạn đang xây mới hay muốn cải tạo nội thất hiện tại, đội ngũ chuyên gia của chúng tôi sẵn sàng đồng hành.',
